...
public class CustomService {
	...
	public CustomService(Environment env) {
		CustomService.customService = env.getRequiredProperty("file_path.CUSTOMSERVICE");
	}
	...
	public static String GET(String URI, String accessToken)
		...
		String appPath = AccessToken.findApplicationDetail(customService, headers);
