...
public class AccountService {
	...
	public static String GET(String URI, String accessToken)
		...
		String appPath = AccessToken.findApplicationDetail(accountService, headers);
...
//if(calling.getACADEMICS_ID() != null) {
	//JSONObject account = new JSONObject(AccountService.GET("account/"+calling.getACADEMICS_ID(), apiRequest.getREQUEST_OUTPUT()));
	//calling.setACADEMICS_DETAIL(account.toString());
//}
...
//		accountList.add(Integer.parseInt(callings.get(i).getACADEMICS_ID().toString()));
//	}
...
//			if(callings.get(i).getACADEMICS_ID() == account.getLong("account_ID") ) {
//				callings.get(i).setACADEMICS_DETAIL(account.toString());
//			}
//		}
//	}
//}
